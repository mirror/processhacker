...
#define KPH_OPENPROCESSTOKEN KPH_CTL_CODE(12)
#define KPH_SUSPENDPROCESS KPH_CTL_CODE(13)
#define KPH_RESUMEPROCESS KPH_CTL_CODE(14)
#define KPH_TERMINATEPROCESS KPH_CTL_CODE(15)
#define KPH_READPROCESSMEMORY KPH_CTL_CODE(16)
