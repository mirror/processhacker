...
namespace ProcessHacker.Common.Objects
{
        ...
        where TEntry : HandleTableEntry, new()
    {
        ...
        /// <returns>The new handle.</returns>
        public int Allocate(BaseObject obj, TEntry entry)
        {
        ...
        /// </returns>
        public BaseObject LookupObject(int handle)
        {
        ...
        /// dereferenced once it is no longer needed.
        /// </returns>
        public BaseObject ReferenceByHandle(int handle, out TEntry entry)
        {
            lock (_handles)
            {
                if (_handles.ContainsKey(handle))
                {
                    BaseObject obj = _handles[handle].Object;
