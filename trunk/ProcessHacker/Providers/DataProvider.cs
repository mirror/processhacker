...
{  
    ...
    {
        #region
        private Dictionary<int,Dictionary<short,SystemHandleInformation>> _handleDic;
        public Dictionary<int,Dictionary<short,SystemHandleInformation>> HandleDictionary;
        #endregion
        ...
        public event Action HandleBeforeUpdate;

        /// <summary>
        /// Occurs when the provider has been updated.
        /// </summary>
        public event Action HandleUpdated;
