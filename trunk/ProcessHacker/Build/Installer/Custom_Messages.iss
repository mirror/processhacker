...
en.msg_AskToDownNET=Process Hacker requires the .NET Framework 2.0. Please download and install the .NET Framework and run setup again. %n%nDo you want to download the .NET Framework 2.0 now?
...
gr.msg_OptimizingPerformance=Βελτίωση επιδόσεων του Process Hacker...
...
gr.tsk_DeleteKPHDervice=Διαγραφή υπηρεσίας του KProcessHacker
gr.tsk_Other=Έξτρα:
