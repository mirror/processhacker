...
if exist "%SEVENZIPBIN%\7z.exe" "%SEVENZIPBIN%\7z.exe" a -mx9 %2\processhacker-3.%MINORVERSION%-sdk.zip %1\sdk\*
...
if exist "%SEVENZIPBIN%\7z.exe" "%SEVENZIPBIN%\7z.exe" a -mx9 %2\processhacker-3.%MINORVERSION%-bin.zip %2\bin\*
