        ...
        <div class="yui-t4">
            <div class="top-portlet">
                <div class="summary">
                    ...
                    <p>Firstly, you need the latest <code>dbghelp.dll</code> version. Install <a href="http://www.microsoft.com/whdc/devtools/debugging/installx86.mspx">Debugging Tools 
                    ...
                    <p>
                        The most likely problem is that you do not have the latest <a href="http://msdn.microsoft.com/en-us/windows/bb980924.aspx">Windows SDK</a> installed.
                    </p>
                </div>
            </div>
        </div>
