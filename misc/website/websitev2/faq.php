    ...
    <div class="yui-d0">
        ...
        <div class="yui-t4">
            ...
            <div class="summary">
                ...
                <p>Yes. If you want settings to be saved on your USB drive, create a file named <code>ProcessHacker.exe.settings.xml</code> in the same directory as <code>ProcessHacker.exe</code>. Settings will then automatically be saved there.</p>
