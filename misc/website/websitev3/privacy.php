<?php $pagetitle = "Privacy Policy"; include "include/header.php"; ?>

<div class="container">
    <div class="row">
        <div class="col-sm-9">
            <h1 class="page-header" id="page-padding"><small>Privacy Policy</small></h1>
            <p>
                ...
                <p><h2 class="page-header"><small>Log Files</small></h2></p>
                <p>
                ...
                <p><h2 class="page-header"><small>Cookies and Web Beacons</small></h2></p>
                <p>
                ...
                <p><h2 class="page-header"><small>DoubleClick DART Cookie</small></h2></p>
                <ul>
                    <li>
