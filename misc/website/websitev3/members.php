    ...
    <h1 class="page-header"><small>Project Members</small></h1>
        ...
        <div class="container">
            ...
            <div class="col-md-6">            
                <div class="media-body">
                    ...
                    <p><span class="label label-info">Founded: 16-10-2008</span></p>
                </div>
                
                <div class="btn-group">
                    <a class="btn btn-primary" href="http://processhacker.sourceforge.net/forums/memberlist.php?mode=email&amp;u=2"><i class="glyphicon glyphicon-comment"></i> Send PM</a>
                    <a class="btn btn-primary" href="http://processhacker.sourceforge.net/forums/memberlist.php?mode=email&amp;u=2"><i class="glyphicon glyphicon-envelope"></i> Send E-mail</a>
                    <a class="btn btn-primary" href="http://wj32.org" target="_blank"><i class="glyphicon glyphicon-globe"></i> wj32.org</a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="col-md-6">            
                ...
                <div class="btn-group">
                    <a class="btn btn-primary" href="http://processhacker.sourceforge.net/forums/memberlist.php?mode=email&amp;u=54"><i class="glyphicon glyphicon-comment"></i> Send PM</a>
                    <a class="btn btn-primary" href="http://processhacker.sourceforge.net/forums/memberlist.php?mode=email&amp;u=54"><i class="glyphicon glyphicon-envelope"></i> Send E-mail</a>
                    <a class="btn btn-primary" href="http://sourceforge.net/users/dmex/" target="_blank"><i class="glyphicon glyphicon-globe"></i> Website</a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="col-md-6">                
                <div class="media-body">
                    ...
                    <p><span class="label label-info">Joined: 20-02-2009</span></p>
                </div>
                
                <div class="btn-group">
                    <a class="btn btn-primary" href=""><i class="glyphicon glyphicon-comment"></i> Send PM</a>
                    <a class="btn btn-primary" href=""><i class="glyphicon glyphicon-envelope"></i> Send E-mail</a>
                    <a class="btn btn-primary" href="http://sourceforge.net/users/xhmikosr/" target="_blank"><i class="glyphicon glyphicon-globe"></i> Website</a>
                </div>
            </div>  
